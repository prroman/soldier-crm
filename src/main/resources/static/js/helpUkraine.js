! function() {
    ...
    function x(e, t) {
        return k(e, t, "vertical", f("div", {
            class: "helpUkraine-widget-container huww-widget-one"
        }, E(), f("p", {
            class: "huww-title"
            ...
            class: "huww-expended-widget-wrapper helpUkraine-widget-container"
        }, P(), f("div", {
            class: "huww-divider"
        }), f("div", {
    ...
    function m(e, t) {
        return k(e, t, "vertical", f("div", {
            class: "helpUkraine-widget-container huww-widget-two"
        }, E(), f("p", {
            class: "huww-title"
    ...
    function y(e, t) {
        return k(e, t, "horizontal", f("div", {
            class: "helpUkraine-widget-container huww-widget-three"
        }, f("p", {
            class: "huww-title"
        }, "Stop War!"), f("p", {
            class: "huww-subtitle"
            ...
            class: "huww-expended-widget-wrapper huww-expended-widget-wrapper-small helpUkraine-widget-container"
        }, P(), f("button", {
    ...
    function v(e, t) {
        return k(e, t, "vertical", f("div", {
            class: "helpUkraine-widget-container huww-widget-four"
        }, f("p", {
            class: "huww-title"
        }, "Help 🇺🇦 Ukraine win!"), f("p", {
            class: "huww-hashtag"
        }, "#StandWithUkraine", "\n#Save Galii Serhii"), f("a", {
            class: "huww-link huww-trigger",
            "data-huww-trigger": d[2],
            href: "#"
    ...
    function j() {
        return f("div", {
            class: "huww-flag-wrapper huww-trigger helpUkraine-widget-container",
            "data-huww-trigger": d[1]
        }, f("div", {
    ...
    function P() {
        ...
        }, L("https://uahelp.monobank.ua", "Donate", "💸", "Donate"), L("https://war.ukraine.ua", "Support Ukraine", "❤", "Info", "huww-heart"))
    }
...
/*                            window.plausible && window.plausible("Outbound Link: Click", {
    ...
    var C, D, I = function() {
        ...
        widgetDomain: (null == C ? void 0 : C.getAttribute(p)) || ""
    }));
